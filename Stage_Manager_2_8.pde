...
void setup()
{
  ...
  actorArray = loadStrings("actors.txt");
  pageArray = loadStrings("pages.txt");
  lineArray = loadStrings("lines.txt");
  noteArray = loadStrings("savedNotes.txt");
  println("Done");
  print(script.length); print(" "); print(actorArray.length); print(" "); print(pageArray.length); print(" "); print(lineArray.length); print(" "); println(noteArray.length);
